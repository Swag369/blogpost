...
#tests that get_replies works for weird cases
def test_get_replies():
    ...
    # no parent_reply, because returns alrdy nested
...
def test_add_reply():
    ...
    new_reply = client.post("/articles/1/new_reply", json = reply_data).json()
